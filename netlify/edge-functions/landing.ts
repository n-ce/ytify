...
export default async function handler(_: Request, context: Context) {
  ...
  const html = `
        ...
        ">
          <svg id="ytifyIcon" xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 4172 4172" width="5vmin"
            height="5vmin" style="transform: scale(10); margin:15vmin 0;
            overflow:hidden">
            <path fill="var(--text)"
          ...
          ytify is a resource efficient audio streaming client for youtube. <a style="
            text-decoration:underline;
          " href="https://github.com/n-ce/ytify/wiki/usage">Learn more about
            how to use the application effectively.</a>
          <br><br>
          <a style="
            text-decoration: underline;
            font-weight: bold;
