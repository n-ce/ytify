...
export const [playAllBtn, enqueueBtn, importListBtn, subscribeListBtn, openInYtBtn, clearListBtn, removeFromListBtn, deleteCollectionBtn, renameCollectionBtn, shareCollectionBtn, radioCollectionBtn, sortCollectionBtn, sortByTitleBtn, sortByAuthorBtn, bulkImportBtn] = <HTMLCollectionOf<HTMLLIElement>>listBtnsContainer.children;
