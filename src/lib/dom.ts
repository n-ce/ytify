...
export const [playAllBtn, enqueueBtn, importListBtn, subscribeListBtn, openInYtBtn, clearListBtn, shareCollectionBtn, removeFromListBtn, deleteCollectionBtn, renameCollectionBtn] = <HTMLCollectionOf<HTMLButtonElement>>listBtnsContainer.children;
