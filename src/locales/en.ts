export const messages = {
    ...
    settings_enter_rgb: "Enter rgb in the format r,g,b",
    settings_incorrect_pin: "Incorrect PIN!",
    settings_enter_piped_api: "Enter Piped API URL :",
    settings_enter_invidious_api: "Enter Invidious API URL :",
    settings_eager_loading: "Eager",
    settings_lazy_loading: "Lazy",
    settings_no_not_load: "Do not load",
    settings_opus_recommended: "Opus (Recommended)",
    settings_share_play: "Play",
    settings_share_download: "Download",
    settings_share_always_ask: "Always ask",
    ...
    settings_theming_toggle_fs: "Toggle Fullscreen",
    settings_up_read_all_prev: "Read all previous changes",
    ...
    pwa_ctp_ctd: "Click ok to Play, click cancel to Download",
    as_setting_up: "Setting up  AudioStreams...",
    as_turn_hls: "Turn on HLS to listen to LiveStreams!",
    as_no_found: "No Audio Streams Found.",
    settings_enter_pin: "Enter PIN",
    imported_to_collections: "{listTitle} has been imported to your collections.",
    set_title: "Set Title",
    fetch_no_url_provided: "No Channel URL provided",
    fetch_not_get_pd: "Could not get playlistData",
    fetch_pl_not_exist: "Got error: \"The playlist does not exist.\""
}