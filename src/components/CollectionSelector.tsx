...
export default function CollectionSelector(_: {
  ...
  return (
    <li>
      ...
      >
        <option>{i18next.t('collection_selector_add_to')}</option>
        <option value="+cl">{i18next.t('collection_selector_create_new')}</option>
        <option value="favorites">{i18next.t('collection_selector_favorites')}</option>
        <option value="listenLater">{i18next.t('collection_selector_listen_later')}</option>
      </select>
    </li>
  );
}
