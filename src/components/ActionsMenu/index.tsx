...
export default function () {
  ...
  createEffect(() => {
    ...
    if (id) setIsListenLater(getCollection("listenLater").includes(id));
  });
  ...
  return (
    ...
    >
      ...
      <ul onclick={(e: Event) => e.stopPropagation()}>
        <li class="clxnShelf" tabindex="-1">
          ...
          <i
            ...
            onclick={() => {
              ...
              if (actionsMenu) {
                ...
                else addToCollection("listenLater", [actionsMenu]);
          ...
          <i aria-label={t("collection_selector_add_to")}>
            <CollectionSelector
              close={closeDialog}
              data={[store.actionsMenu as TrackItem]}
            />
          </i>
        </li>
        ...
        >
          ...
          ></i>
          {t(
            isMusic ? "actions_menu_view_artist" : "actions_menu_view_channel",
          )}
        </li>
