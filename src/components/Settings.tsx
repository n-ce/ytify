    ...
    <>
      <div>
        ...
        <ToggleSwitch
          ...
          name={i18next.t('settings_custom_instance')}
          ...
          onClick={() => {
            ...
            if (getSaved(_))
              ...
              const pi = prompt(i18next.t('settings_enter_piped_api'), 'https://pipedapi.kavin.rocks');
              const iv = prompt(i18next.t('settings_enter_invidious_api'), 'https://iv.ggtyler.dev');
        ...
        <Selector
          label={i18next.t('settings_language')}
          id='languageSelector'
          onChange={(e) => {
        ...
        <Selector
          id='linkHost'
          label={i18next.t('settings_links_host')}
          onChange={(e) => {
        ...
        <Selector
          label={i18next.t('settings_image_loading')}
          id='imgLoad'
          onChange={(e) => {
        ...
        >
          <option value="eager">{i18next.t('settings_image_eager')}</option>
          <option value="lazy">{i18next.t('settings_image_lazy')}</option>
          <option value="off">{i18next.t('settings_image_off')}</option>
        </Selector>

        <Selector
          id='downloadFormatSelector'
          label={i18next.t('settings_download_format')}
          onChange={(e) => {
        ...
        <Selector
          id='shareAction'
          label={i18next.t('settings_pwa_share_action')}
          onChange={(e) => {
            const val = e.target.value;
            if (val === 'play')
        ...
        >
          <option value='play'>{i18next.t('settings_pwa_play')}</option>
          <option value='dl'>{i18next.t('settings_pwa_download')}</option>
          <option value='ask'>{i18next.t('settings_pwa_always_ask')}</option>
        </Selector>
      ...
      <div>
        <b>
          ...
          <p>{i18next.t('settings_search')}</p>
        </b>
        <ToggleSwitch
          id="defaultFilterSongs"
          name={i18next.t('settings_set_songs_as_default_filter')}
        ...
        <ToggleSwitch
          ...
          name={i18next.t('settings_display_suggestions')}
      ...
      <div>
        <b>
          ...
          <p>{i18next.t('settings_playback')}</p>
        </b>


        <ToggleSwitch
          id="qualitySwitch"
          name={i18next.t('settings_hq_audio')}
        ...
        <Show when={!getSaved('HLS')}>
          ...
          <ToggleSwitch
            ...
            name={i18next.t('settings_stable_volume')}
          ...
          <ToggleSwitch
            ...
            name={i18next.t('settings_always_proxy_streams')}
      ...
      <div>
        <b>
          ...
          <p>{i18next.t('settings_library')}</p>
        </b>


        <ToggleSwitch
          id="startupTab"
          name={i18next.t('settings_set_as_default_tab')}
        ...
        <ToggleSwitch
          id='discoverSwitch'
          name={i18next.t('settings_store_discoveries')}
          ...
          onClick={e => {
            if (e.target.checked)
              ...
              const db = getDB();
              if (confirm(i18next.t("settings_clear_discoveries", { count: Object.keys(db.discover || {}).length || 0 }))) {
                delete db.discover;
                saveDB(db);
                save('discover', 'off');
              }
        ...
        <ToggleSwitch
          id='historySwitch'
          name={i18next.t('settings_store_history')}
          ...
          onClick={e => {
            if (e.target.checked)
              ...
              const db = getDB();
              if (confirm(i18next.t("settings_clear_history", { count: Object.keys(db.discover || {}).length || 0 }))) {
                delete db.history;
                saveDB(db);
                save('history', 'off')
              } else e.preventDefault();
        ...
        }}>{i18next.t('settings_import_from_piped')}</p>
      ...
      <div>
        <b>
          ...
          <p>{i18next.t('settings_interface')}</p>
        </b>

        <Selector
          label={i18next.t('settings_roundness')}
          id='roundnessChanger'
          onChange={(e) => {
        ...
        >
          <option value="none">{i18next.t('settings_roundness_none')}</option>
          <option value="0.2rem">{i18next.t('settings_roundness_lighter')}</option>
          <option value="0.4rem" selected>{i18next.t('settings_roundness_light')}</option>
          <option value="0.6rem">{i18next.t('settings_roundness_heavy')}</option>
          <option value="0.9rem">{i18next.t('settings_roundness_heavier')}</option>
        </Selector>


        <ToggleSwitch
          id="custom_theme"
          name={i18next.t('settings_use_custom_color')}
          ...
          onClick={e => {
            ...
            if (colorString)
              ...
              const rgbText = i18next.t('settings_custom_color_prompt');
        ...
        <Selector
          label={i18next.t('settings_theming_scheme')}
          id='themeSelector'
          onChange={(e) => {
            themer();
            e.target.value === 'auto' ?
        ...
        >
          <optgroup label={i18next.t('settings_theming_scheme_dynamic')}>
            <option value="auto" selected>{i18next.t('settings_theming_scheme_system')}</option>
            <option value="light">{i18next.t('settings_theming_scheme_light')}</option>
            <option value="dark">{i18next.t('settings_theming_scheme_dark')}</option>
          </optgroup>
          <optgroup label={i18next.t('settings_theming_scheme_hc')}>
            <option value="auto-hc">{i18next.t('settings_theming_scheme_hc_system')}</option>
            <option value="white">{i18next.t('settings_theming_scheme_white')}</option>
            <option value="black">{i18next.t('settings_theming_scheme_black')}</option>
          </optgroup>
        </Selector>
        ...
        }>{i18next.t('settings_fullscreen')}</p>
      </div>
      ...
      <div>
        <b>
          ...
          <p>{i18next.t('settings_parental_controls')}</p>
        </b>

        <ToggleSwitch
          id="kidsSwitch"
          name={i18next.t('settings_pin_toggle')}
          ...
          onClick={e => {
            ...
            if (savedPin) {
              if (prompt('Enter PIN to disable parental controls :') === savedPin) {
                ...
                alert(i18next.t('settings_pin_incorrect'));
                e.preventDefault();
              }
              return;
            }
            const pin = prompt(i18next.t('settings_pin_message'));
            if (pin) {
              save('kidsMode', pin);
              location.reload();
            }
