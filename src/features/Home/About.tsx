...
export default function() {
  return (
    <div class="about">
      ...
      ytify is a resource efficient audio streaming platform that leverages the YouTube & YTMusic library.
      <br />
      <a
        class="underline"
      ...
      <span>
        ...
        <a data-translation="settings_changelog" href="https://github.com/n-ce/ytify/wiki/changelog"
