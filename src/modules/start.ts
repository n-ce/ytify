...
export default async function() {
  ...
  const { customInstance, shareAction } = state;
        ...
        <div align="center">
          ...
          <p style="font-size:smaller;margin-top:1rem">
            <img
              ...
              To support with connectivity costs donations can be made through the United Payments Interface at <b>animesh.5383@waicici</b>, even a small amount can help.
          </p>
          <a style='text-decoration: underline;' href='https://en.m.wikipedia.org/wiki/Individual_action_on_climate_change' target='_blank'>What can one individual do to deal with climate change?</a>
      </div>
    `);
